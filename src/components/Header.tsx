...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#F0F2FF]/95 backdrop-blur-md border-b border-indigo-100/80 transition-colors">
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 text-white text-[11px] font-bold py-2 px-4 text-center flex items-center justify-center gap-2 shadow-xs">
        ...
        <button 
          ...
          className="bg-white/20 hover:bg-white/30 text-white text-[10px] uppercase tracking-wider font-extrabold px-2.5 py-0.5 rounded-full transition-colors cursor-pointer ml-1.5"
        >
          Cek tahapan Kamu →
        </button>
      </div>
...
<button 
  ...
  id="brand-logo-btn"
>
  <div className="w-11 h-11 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-200 group-hover:scale-105 transition-transform overflow-hidden">
    <img src="/image/logo.png" alt="Souls Care Logo" className="w-full h-full object-cover" />
  </div>
  <div>
        <span className="font-['Outfit',sans-serif] font-black text-2xl tracking-tight text-indigo-900 flex items-center gap-2">
                  Souls Care
                  <span className="text-[10px] uppercase font-extrabold tracking-widest px-2 py-0.5 rounded-full bg-pink-100 text-pink-700 border border-pink-200">
                    Gen Z
                  </span>
                </span>
                <p className="text-[11px] font-bold text-indigo-400 tracking-wide hidden sm:block">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                <span className="text-[10px] uppercase tracking-wider text-indigo-400 font-extrabold">Mood</span>
                <span className="text-xs font-black text-indigo-900">{currentMood || '🌿 Netral'}</span>
              </button>
              ...
              {showMoodDropdown && (
                ...
                >
                  <p className="text-[10px] font-black text-indigo-400 px-3 py-1.5 uppercase tracking-wider">
            ...
            <button
              ...
              onClick={onOpenSlidingScale}
              className="bg-white px-4 py-2 rounded-full border-2 border-indigo-100 hover:border-indigo-200 flex items-center gap-2 shadow-xs transition-all hover:scale-102 cursor-pointer"
            >
              <span className="text-[10px] font-extrabold text-indigo-400 uppercase tracking-widest">Sliding Scale</span>
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-full border-2 border-amber-200 bg-[#FEF3C7] hover:bg-amber-100 text-amber-900 text-xs font-bold transition-all shadow-xs hover:scale-102 cursor-pointer"
            >
              <PiggyBank className="w-3.5 h-3.5 text-amber-600" />
              <span className="text-[10px] uppercase tracking-wider text-amber-700 font-extrabold">Vault:</span>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-600 hover:to-red-700 text-white text-xs font-black shadow-lg shadow-rose-200 transition-all hover:scale-105 cursor-pointer"
            >
            ...
            <div className="w-10 h-10 bg-white rounded-full border-2 border-white overflow-hidden shadow-md">
              <div className="w-full h-full bg-gradient-to-br from-pink-400 to-orange-300 flex items-center justify-center text-white font-black text-xs">
                ✨
              </div>
            </div>
          </div>
                  ...
                  {item.badge && (
                    <span
                      className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${
                        isActive ? 'bg-pink-400 text-white' : 'bg-indigo-100 text-indigo-700'
                      }`}
                    >
                      {item.badge}
                    </span>
        ...
        <div className="lg:hidden border-t-2 border-indigo-100 bg-white p-5 space-y-3 animate-in slide-in-from-top duration-200 shadow-2xl rounded-b-[32px]">
          <div className="grid grid-cols-2 gap-2.5 pb-3 border-b border-indigo-50">
            <button
              ...
              className="p-3 rounded-2xl border-2 border-indigo-100 bg-indigo-50/50 text-xs font-black text-left flex flex-col gap-1 text-indigo-900"
            >
              <div className="flex items-center gap-1 text-[10px] uppercase font-black text-indigo-400 tracking-wider">
            ...
            <button
              ...
              className="p-3 rounded-2xl border-2 border-amber-200 bg-[#FEF3C7] text-xs font-black text-left flex flex-col gap-1 text-amber-900"
            >
              <div className="flex items-center gap-1 text-[10px] uppercase font-black text-amber-700 tracking-wider">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-2xl text-xs font-black ${
                ...
                >
                  ...
                  {item.badge && (
                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-black ${isActive ? 'bg-pink-400 text-white' : 'bg-pink-100 text-pink-700'}`}>
                      {item.badge}
                    </span>
                  )}
                </button>
