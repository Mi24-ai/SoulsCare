    ...
    <div className="space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="bg-white/15 rounded-3xl p-5 backdrop-blur-md border border-white/20 text-left shrink-0 shadow-lg max-w-xs">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-amber-400 hover:bg-amber-300 text-indigo-950 font-bold text-xs rounded-2xl shadow-md shadow-amber-900/20 transition-all hover:scale-[1.02] flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      <div className="bg-white rounded-[36px] border-2 border-indigo-50 p-6 sm:p-8 shadow-xl shadow-indigo-100/60">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-indigo-50">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-indigo-950 text-lg">{activePolicy.name}</h3>
                <span className="px-3 py-0.5 rounded-full bg-emerald-50 text-emerald-800 text-[11px] font-bold uppercase tracking-wider border border-emerald-200">
                  Aktif & Terlindungi
                </span>
              </div>
          ...
          <div className="flex items-center gap-6">
            <div>
              <div className="text-[11px] text-indigo-400 uppercase font-bold tracking-wider">Sisa Limit Klaim Tahunan</div>
            ...
            <button
              onClick={() => setClaimModalOpen(true)}
              className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-2xl shadow-md shadow-indigo-200 transition-all hover:scale-[1.02] cursor-pointer"
            >
              + Ajukan Klaim
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 text-xs">
          <div className="p-4 bg-[#F0F2FF] rounded-2xl border-2 border-indigo-100">
            <span className="text-[11px] uppercase font-bold text-indigo-400 block mb-1">Konseling Psikolog</span>
            <p className="font-bold text-indigo-950">{activePolicy.counselingCoverage}</p>
          </div>
          <div className="p-4 bg-[#F0F2FF] rounded-2xl border-2 border-indigo-100">
            <span className="text-[11px] uppercase font-bold text-indigo-400 block mb-1">Resep Obat Psikiater</span>
            <p className="font-bold text-indigo-950">{activePolicy.psychiatristMedCoverage}</p>
          </div>
          <div className="p-4 bg-[#F0F2FF] rounded-2xl border-2 border-indigo-100">
            <span className="text-[11px] uppercase font-bold text-indigo-400 block mb-1">Hotline & Mediasi Darurat</span>
            <p className="font-bold text-indigo-950">{activePolicy.emergencyCrisisCoverage}</p>
          </div>
        </div>
      </div>
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {policy.isPopular && (
                      <span className="px-3 py-1 rounded-full bg-pink-50 text-pink-700 text-[11px] font-bold border border-pink-200">
                        Paling Favorit
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mb-6 pb-4 border-b border-indigo-50">
                    <div className="flex items-baseline gap-1">
                      <span className="text-3xl font-bold text-indigo-950 font-mono">
      ...
      <div className="bg-white rounded-[36px] border-2 border-indigo-50 p-6 sm:p-8 shadow-xl shadow-indigo-100/60 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => setClaimModalOpen(true)}
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-2xl shadow-md shadow-indigo-200 cursor-pointer"
          >
            + Klaim Baru
          </button>
        </div>
          ...
          {claims.map((claim) => (
            ...
            >
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-indigo-950">{claim.category}</span>
                    <span className="text-[11px] text-indigo-400 font-mono">{claim.receiptNumber}</span>
                  </div>
                  <p className="text-indigo-900 font-medium mt-0.5">{claim.notes}</p>
                  <span className="text-[11px] font-bold text-indigo-300">{claim.date}</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-[36px] shadow-2xl border-2 border-indigo-50 max-w-lg w-full overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 space-y-4 overflow-y-auto">
              ...
              <div>
                ...
                <div className="p-5 border-2 border-dashed border-indigo-200 rounded-3xl text-center bg-[#F0F2FF]/50 hover:bg-[#F0F2FF] cursor-pointer">
                  ...
                  <p className="text-[11px] text-indigo-400 mt-1 font-medium">Mendukung JPG, PNG, PDF (maks 5MB)</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 border-t border-indigo-50 bg-[#F0F2FF] flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white text-xs font-bold shadow-lg shadow-indigo-200 transition-all hover:scale-[1.02] cursor-pointer"
              >
