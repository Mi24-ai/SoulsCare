    ...
    <div className="space-y-8">
          ...
          <div className="bg-white/15 p-6 rounded-3xl backdrop-blur-md border border-white/20 text-left shrink-0 space-y-3 shadow-lg min-w-[240px]">
            ...
            <div className="flex gap-2 pt-1">
              <button
                ...
                className="px-4 py-2.5 rounded-2xl bg-amber-400 hover:bg-amber-300 text-indigo-950 font-black text-xs shadow-md shadow-amber-900/20 transition-all hover:scale-105 flex items-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-3.5 py-2.5 rounded-2xl bg-white/20 hover:bg-white/30 text-white font-black text-xs transition-colors cursor-pointer"
              >
                Tukar Sesi
              </button>
            </div>
      ...
      <div className="bg-white rounded-[36px] border-2 border-indigo-50 p-6 sm:p-8 shadow-xl shadow-indigo-100/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-indigo-950 text-lg">Round-Up Receh Belanjaan Otomatis</h3>
        ...
        <button
          ...
          className={`px-5 py-3 rounded-2xl text-xs font-black transition-all shrink-0 cursor-pointer shadow-md ${
            roundUpToggle
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black rounded-2xl flex items-center gap-2 shadow-md shadow-indigo-200 transition-all hover:scale-105 cursor-pointer"
          >
            <Plus className="w-4 h-4" />
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-[10px] uppercase font-black tracking-wider px-3 py-1 rounded-full bg-[#F0F2FF] text-indigo-800 border border-indigo-100">
                      {goal.category}
                    </span>
                    {isCompleted && (
                      <span className="flex items-center gap-1 text-[10px] font-black text-emerald-800 bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 rounded-full">
                        <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> Tercapai
                      </span>
                    )}
                  </div>

                  <h3 className="font-black text-indigo-950 text-lg font-['Outfit',sans-serif] mb-4">
                    {goal.title}
                  </h3>
                  ...
                  <div className="space-y-2 mb-5">
                    <div className="flex justify-between text-xs font-bold text-indigo-400">
                      <span>Terkumpul:</span>
                      <span className="font-black text-indigo-950">{progress}%</span>
                    </div>
                ...
                <button
                  ...
                  className="w-full py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black shadow-md shadow-indigo-200 transition-all flex items-center justify-center gap-1.5 cursor-pointer hover:scale-105"
                >
                  <Plus className="w-4 h-4" />
          ...
          <div className="bg-white rounded-[36px] shadow-2xl border-2 border-indigo-50 max-w-md w-full overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-2 mb-2">
                  {['20000', '50000', '100000'].map((amt) => (
                    <button
                      ...
                      className={`p-2.5 rounded-2xl border-2 text-xs font-mono font-black transition-all cursor-pointer ${
                        depositAmount === amt
            ...
            <div className="p-5 border-t border-indigo-50 bg-[#F0F2FF] flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black shadow-lg shadow-indigo-200 transition-all hover:scale-105 cursor-pointer"
              >
                Konfirmasi Nabung
              </button>
            </div>
      ...
      {isNewGoalModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-indigo-950/70 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white rounded-[36px] shadow-2xl border-2 border-indigo-50 max-w-md w-full overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="text-xs font-black text-indigo-950 block mb-1.5">Nama Target:</label>
                <input
                  type="text"
                  value={newTitle}
              ...
              <div>
                <label className="text-xs font-black text-indigo-950 block mb-1.5">Kategori:</label>
                <select
                  value={newCategory}
              ...
              <div>
                <label className="text-xs font-black text-indigo-950 block mb-1.5">Target Nominal (Rupiah):</label>
                <input
                  type="number"
                  value={newTarget}
            ...
            <div className="p-5 border-t border-indigo-50 bg-[#F0F2FF] flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-40 text-white text-xs font-black shadow-lg shadow-indigo-200 transition-all hover:scale-105 cursor-pointer"
              >
                Buat Target
              </button>
            </div>
